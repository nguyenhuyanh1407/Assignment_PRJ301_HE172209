<%-- 
    Document   : login
    Created on : Feb 15, 2025, 9:57:09 AM
    Author     : ibm
--%>
        ...
        <div class="row gy-5 justify-content-center">
          ...
          <div class="col-12 col-lg-5 d-flex align-items-center">
            <div class="d-flex gap-3 flex-column w-100 ">
                ...
                <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:9999/LeaveApplicationSystem/login&response_type=code&client_id=792310213918-vn7ev3t9o6hrpe37h5viugvhipjhacpm.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger">
