        ...
        <div class="row gy-5 justify-content-center">
          ...
          <div class="col-12 col-lg-5 d-flex align-items-center">
            <div class="d-flex gap-3 flex-column w-100 ">
                ...
                <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:9999/LRManagementSystem/login&response_type=code&client_id=925609835875-tnab0l13iipdr207uoc3o6c4qcs1ks52.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger">
